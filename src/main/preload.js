...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  exportShareableInvoiceHtml: (invoiceId) => ipcRenderer.invoke('invoices:exportShareableHtml', invoiceId),
  exportPaymentsPdf: (filter) => ipcRenderer.invoke('payments:exportPdf', filter),
  ...
  exportRevenueReportPdf: (filter) => ipcRenderer.invoke('reports:exportRevenuePdf', filter),
  exportProfitLossPdf: (filter) => ipcRenderer.invoke('reports:exportProfitLossPdf', filter),
  exportClientProfitabilityPdf: (filter) => ipcRenderer.invoke('reports:exportClientProfitabilityPdf', filter),
